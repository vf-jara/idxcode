            ...
            <div className="h-full pt-10 lg:pt-20">
                <div className="w-full bg-white">
                    <div className="container mx-auto flex">
                        <div ref={ref} className="mb-4 lg:flex-col w-full lg:w-1/2">
                            <h1 className={`titleHero ${inView && "slideRight delay-2"}`}>Soluções em<br /> tecnologia para a sua empresa crescer</h1>
                        </div>
                        <div className="hidden lg:flex-col mb-5 w-1/2">
                        </div>
                    </div>
                </div>
                <div ref={ref} className="w-full bg-idx-bg-black">
                    <div className="container mx-auto flex">
                        <div ref={ref} className={`pb-10 lg:flex-col w-full lg:w-1/2  ${inView && "slideRight delay-2"}`}>
                        ...
                        <div className="hidden lg:block mb-10 flex-col w-1/2 relative">
                            <div ref={ref} className={`absolute bottom-[70px] right-[-10vw] ${inView && "slideLeft"}`}>
